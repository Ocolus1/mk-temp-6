...
function TestimonialSection() {
  ...
  return (
    <div className="testimonial bg-[#FFF4F2] py-10">
      <div className="max-w-8xl mx-auto">
        <div className="flex flex-col lg:flex-row items-center gap-y-5 justify-between max-w-6xl mx-auto">
          <div className="testimonial-headline flex flex-col  gap-y-2  px-10">
            <div className="flex w-fit mx-auto lg:mx-0 items-center justify-center lg:justify-start lg:items-start rounded-full bg-[#D0E4FF] text-black py-[3px] px-2 lg:px-4 lg:py-1.5 font-semibold text-[10px] lg:text-xs">
              <span>REVIEWS</span>
            </div>
            <h3 className="text-2xl sm:text-4xl lg:text-[44px] max-w-xs mx-auto md:max-w-full md:mx-0 text-center lg:text-left font-bold leading-[1.5] lg:leading-[1.25] text-black">
              An enterprise template to ramp up your company website
            </h3>
          </div>
          <div className="scrollable button flex items-center justify-center gap-x-3 w-1/3">
            <div
              className="flex items-center gap-x-2 p-3 rounded-full bg-[#F0F5FC] shadow-md"
            ...
            <div
              className="flex items-center gap-x-2 p-3 rounded-full bg-white shadow-md"
