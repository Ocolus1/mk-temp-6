...
function MobileMenu({ onClose }) {
  ...
  return (
    <div className="main-nav-menu-mobile z-50 bg-zinc-50 opacity-[0.98] shadow-sm lg:shadow-none absolute left-0 top-0 bottom-0 right-0 border-r border-slate-400/30 border-dashed w-[270px] md:w-[300px] lg:flex lg:w-[300px] lg:flex-col">
      <div>
        <button>
        ...
        <div className="header-menu lg:hidden">
          ...
          <div className="header-button space-y-2">
            <div className=" px-6 lg:flex lg:items-center">
              <a
                href="#"
                className="flex w-full items-center text-white justify-center rounded-full bg-[#6498DD] px-6 py-2.5 font-semibold hover:shadow-lg hover:drop-shadow transition duration-200"
              >
                <span>Join now</span>
              </a>
            </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="header-button space-x-2">
            <div className="hidden lg:flex lg:items-center">
              <button className="flex items-center text-white justify-center rounded-full bg-[#6498DD] px-6 py-2.5 font-semibold hover:shadow-lg hover:drop-shadow transition duration-200">
                <span>Join now</span>
              </button>
            </div>
          </div>
